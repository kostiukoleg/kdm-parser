...
def main():
    ...
    #             j.get_pages(str(config['GLOVIS']['ATN_NUM']), 4, 1, MAX_PAGE)
            ...
            #     s_page = j.fetch('{}?searchAuctno={}&prodmancd={}&ac={}&atn={}&acc={}'.format( config['GLOVIS']['URL'], str(209), 'TQhYt3GD6GvgPdVw1QX+Wg==', 'hHmv6fGU8/9XeUf4aKXBZg==', 'u9cesU3il5ljSzAzHZzmEg==' ))
            #     MAX_PAGE = j.get_max_page(s_page)
            #     j.get_pages(int(config['GLOVIS']['ATN_NUM']), 4, 1, int(MAX_PAGE))
            # elif(category == "Cadillac"):
            #     s_page = j.fetch('{}?searchAuctno={}&prodmancd={}&ac={}&atn={}&acc={}'.format( config['GLOVIS']['URL'], str(112), 'TQhYt3GD6GvgPdVw1QX+Wg==', 'hHmv6fGU8/9XeUf4aKXBZg==', 'u9cesU3il5ljSzAzHZzmEg==' ))
        ...
        with Pool(30) as p:#20
            p.map(j.get_car_mysql, all_links)
